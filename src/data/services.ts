export const services = [
  ...
  },
  {
    ...
    copy: "New aluminum frames, hardware repair, and precise re-screening in white or bronze with black, charcoal, or light-gray mesh.",
  ...
  },
  {
    ...
    copy: "Premium all-aluminum doors with nylon wheels, custom adjusted for a smooth glide in single or double-door openings.",
  ...
  },
  {
    ...
    copy: "Hurricane Fabric protection that deploys in minutes, stores compactly, and can be fitted for safe inside or outside access.",
