export const serviceMeta = {
  "screen-doors": {
    ...
    bullets: ["Single, double, and French door systems", "White aluminum frames", "Kickplate, grille, bar, and security options"],
  },
  "motorized-screens": {
    ...
    bullets: ["Large-format screen systems", "Insect and solar shade fabrics", "Rainier and Wizard systems"],
  },
  "window-screens": {
    ...
    bullets: ["New custom aluminum frames", "Re-screening and hardware repair", "Black, charcoal, or light gray mesh"],
  },
  "sliding-screen-doors": {
    ...
    bullets: ["Premium all-aluminum frames", "Smooth, serviceable nylon wheels", "Single and double-door systems"],
  },
  "hurricane-screens": {
    ...
    bullets: ["Hurricane Fabric systems", "Custom anchoring hardware", "Inside or outside deployment"],
  },
  "screen-repair": {
    title: "Screen Repair",
